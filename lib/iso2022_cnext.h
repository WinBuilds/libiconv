...
iso2022_cn_ext_wctomb (conv_t conv, unsigned char *r, ucs4_t wc, size_t n)
{
  ...
  if (ret != RET_ILUNI) {
    if (ret != 1) abort();
    if (buf[0] < 0x80) {
      size_t count = (state1 == STATE_ASCII ? 1 : 2);
      if (n < count)
        return RET_TOOSMALL;
  ...
  if (ret != RET_ILUNI) {
    ...
    if (buf[0] < 0x80 && buf[1] < 0x80) {
      size_t count = (state2 == STATE2_DESIGNATED_GB2312 ? 0 : 4) + (state1 == STATE_TWOBYTE ? 0 : 1) + 2;
      if (n < count)
        return RET_TOOSMALL;
  ...
  if (ret != RET_ILUNI) {
    ...
    if (buf[0] == 1 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state2 == STATE2_DESIGNATED_CNS11643_1 ? 0 : 4) + (state1 == STATE_TWOBYTE ? 0 : 1) + 2;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 2 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state3 == STATE3_DESIGNATED_CNS11643_2 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 3 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state4 == STATE4_DESIGNATED_CNS11643_3 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 4 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state4 == STATE4_DESIGNATED_CNS11643_4 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 5 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state4 == STATE4_DESIGNATED_CNS11643_5 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 6 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state4 == STATE4_DESIGNATED_CNS11643_6 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
    ...
    if (buf[0] == 7 && buf[1] < 0x80 && buf[2] < 0x80) {
      size_t count = (state4 == STATE4_DESIGNATED_CNS11643_7 ? 0 : 4) + 4;
      if (n < count)
        return RET_TOOSMALL;
  ...
  if (ret != RET_ILUNI) {
    if (ret != 2) abort();
    if (buf[0] < 0x80 && buf[1] < 0x80) {
       size_t count = (state2 == STATE2_DESIGNATED_ISO_IR_165 ? 0 : 4) + (state1 == STATE_TWOBYTE ? 0 : 1) + 2;
      if (n < count)
        return RET_TOOSMALL;
